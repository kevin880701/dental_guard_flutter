...
import '../domain/usecases/line_oauth_login_usecase.dart';
...
final lineOAuthLoginUseCaseProvider = Provider<LineOAuthLoginUseCase>((ref) {
  final repo = ref.read(authRepositoryProvider);
  return LineOAuthLoginUseCase(repo);
});
