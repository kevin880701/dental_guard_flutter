...
class AuthRemoteDataSource {
  ...
  Future<bool> setUserProfile(SetUserProfileRequest request) async {
    final response = await networkInterface.patch(
      url: ApiEndPoint.userProfile,
      body: request.toJson(),
    );

    return await parseApiResponse<bool>(
      response.data,
          (json) => json as bool,
    );
  }
  ...
  Future<String> sendVerificationCode(
    ...
    final response = await networkInterface.post(
      url: ApiEndPoint.sendVerificationCode,
      body: request.toJson(),
    );
  ...
  Future<bool> enterVerificationCode(
      EnterVerificationCodeRequest request,
      ) async {
    final response = await networkInterface.post(
      url: ApiEndPoint.enterVerificationCode,
      body: request.toJson(),
    );
  ...
  Future<LoginData> registerPassword(SetPasswordRequest request) async {
    final response = await networkInterface.post(
      url: ApiEndPoint.registerPassword,
      body: request.toJson(),
    );
