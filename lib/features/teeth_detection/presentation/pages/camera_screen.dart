      ...
      child: Scaffold(
        body: SafeArea(
          child: cameraState.isInitialized &&
                  cameraState.cameraController != null
              ? Column(
                  children: [
                    Container(
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                              onPressed: () async {
                                ...
                                if (path != null) {
                                  teethDetectionNotifier
                                      .setTempImage(File(path));
                                } else {
                                  AppToast.showToast(
                                      message: AppStrings.shootingFailed);
                                }
                                context.pop();
                              },
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Slider(
                              value: cameraState.offsetX
                                  .clamp(0.0, 1.0 - cameraState.cropWidthRatio),
                              min: 0.0,
