...
mixin _$AnalyzeResultData {
  ...
  String get teethInfo => throw _privateConstructorUsedError;
...
abstract class $AnalyzeResultDataCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'teeth_info') String teethInfo,
...
class _$AnalyzeResultDataImpl implements _AnalyzeResultData {
  const _$AnalyzeResultDataImpl(
      ...
      @JsonKey(name: 'teeth_info') required this.teethInfo,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.teethInfo, teethInfo) ||
                other.teethInfo == teethInfo) &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, analyzePath, score,
      isSuccess, mark, execTime, teethInfo, createdAt);
...
abstract class _AnalyzeResultData implements AnalyzeResultData {
  const factory _AnalyzeResultData(
          ...
          @JsonKey(name: 'teeth_info') required final String teethInfo,
