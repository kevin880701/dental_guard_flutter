...
class _$GetUserBrushingStatsRequestImpl
  ...
  @override
  String toString() {
    return 'GetUserBrushingStatsRequest(userId: $userId, startDate: $startDate, endDate: $endDate, timeSpace: $timeSpace, timeZone: $timeZone, needBaseLineData: $needBaseLineData)';
  }
