...
class _$BaseResponseImpl<T> implements _BaseResponse<T> {
  ...
  @override
  String toString() {
    return 'BaseResponse<$T>(returnCode: $returnCode, message: $message, data: $data)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, returnCode, message,
...
abstract class _BaseResponse<T> implements BaseResponse<T> {
  const factory _BaseResponse(
      ...
      @JsonKey(name: 'data') required final T data}) = _$BaseResponseImpl<T>;
